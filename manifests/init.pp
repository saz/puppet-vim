...
class vim (
  ...
  Optional[String] $set_editor_cmd    = $vim::params::set_editor_cmd,
  Optional[String] $test_editor_set   = $vim::params::test_editor_set,
  Stdlib::Unixpath $conf_file         = $vim::params::conf,
